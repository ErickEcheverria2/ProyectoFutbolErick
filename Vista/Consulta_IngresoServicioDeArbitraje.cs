...
{
    public partial class Consulta_IngresoServicioDeArbitraje : Form
    {
        public ConsultasDB consultaDB = new ConsultasDB();

        public Consulta_IngresoServicioDeArbitraje()
        {
            InitializeComponent();
        }
        ...
        private void buscar_Click(object sender, EventArgs e)
        {
            ...
            {
                listConsulta.DataSource = consultaDB.consulta_montoGeneradoXServicioDeArbitrajeDiaxDia(fechaInicio, fechaFinal);
            }
        }
    }
}
